...
OUT_JSON = OUT_DIR / "v1_1_feature_experiment.json"
OUT_CSV = OUT_DIR / "v1_1_feature_experiment.csv"
OUT_ROWS = OUT_DIR / "v1_1_training_events.csv"
...
def main():
    ...
    selected_name = max(eligible, key=lambda x: x[1])[0] if eligible else "base32_retrained"

    out = {
        "research_version": "v1.1-feature-experiment-20260920",
        "v1_frozen": True,
